...
MODEL_POOL = {
    ...
    # StyleGAN Official.
    'stylegan_anime': {
        'weight_path': os.path.join(MODEL_DIR, PTH_MODEL_DIR, 'stylegan_anime_generator.pth'),
        'weight_D_path':os.path.join(MODEL_DIR, PTH_MODEL_DIR, '2019-04-30-stylegan-danbooru2018-portraits-02095-066083_d.pt'),
        'tf_weight_path': os.path.join(MODEL_DIR, TF_MODEL_DIR, '2019-04-30-stylegan-danbooru2018-portraits-02095-066083.pkl'),
        'tf_code_path': os.path.join(BASE_DIR, 'stylegan_tf_official'),
        'noise_dir': os.path.join(os.path.dirname(BASE_DIR), "anime_noise"),
        'gan_type': 'stylegan',
        'dataset_name': 'anime',
        'z_space_dim': 512,
        'w_space_dim': 512,
    ...
    'stylegan_ffhq': {
        ...
        'weight_D_path': os.path.join(MODEL_DIR, PTH_MODEL_DIR, 'karras2019stylegan-ffhq-1024x1024_d.pt'),
        'tf_weight_path': os.path.join(MODEL_DIR, TF_MODEL_DIR, 'karras2019stylegan-ffhq-1024x1024.pkl'),
        'tf_code_path': os.path.join(BASE_DIR, 'stylegan_tf_official'),
        'noise_dir': os.path.join(os.path.dirname(BASE_DIR), "ffhq_noise"),
        'gan_type': 'stylegan',
        'dataset_name': 'ffhq',
        'z_space_dim': 512,
        'w_space_dim': 512,
